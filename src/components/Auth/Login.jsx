...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center py-28 justify-center relative overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
            ...
            <div className="text-white max-w-md">
              ...
              >
                ...
                <p className="text-gray-300 mb-8 text-lg">
                  Log in to access your personalized exam dashboard and continue your journey to success.
                </p>
              </motion.div>
          ...
          <div className="md:w-1/2 p-8 md:p-12 bg-gray-900 rounded-r-2xl">
            <motion.div variants={formVariants} initial="hidden" animate="visible">
              <motion.div variants={itemVariants}>
                ...
                <p className="text-gray-400 mb-8">Access your ExamGenius account</p>
              </motion.div>
                ...
                <motion.div variants={itemVariants} className="flex items-center justify-between mb-6">
                  <div className="flex items-center">
                    <input
                      id="remember-me"
                      type="checkbox"
                      className="h-4 w-4 text-fuchsia-600 focus:ring-fuchsia-500 border-gray-700 rounded bg-gray-800"
                    />
                  ...
                  <div className="text-sm">
                    <Link to="/forgot-password" className="font-medium text-fuchsia-400 hover:text-fuchsia-300">
